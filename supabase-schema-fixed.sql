-- ============================================================
-- HERLYKKE 전체 스키마 (수정판 · 재실행 안전)
-- 부분 적용분을 먼저 비우고 깨끗이 다시 생성합니다.
-- ============================================================
DROP TABLE IF EXISTS reports, likes, comments, posts, daily_logs, solution_reviews, seller_applications, checkin_onboarding, profiles CASCADE;
