...
export function SymptomFrequency({ data, totalDays }: SymptomFrequencyProps) {
  if (data.length === 0) {
    return (
      <div className="bg-white rounded-2xl p-5 border border-alma-border">
        <h3 className="font-semibold text-alma-text mb-4">증상 빈도</h3>
  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-alma-border">
      <h3 className="font-semibold text-alma-text mb-4">주요 증상 TOP 5</h3>
          ...
          return (
            <div key={symptom.symptomId}>
              ...
              <div className="flex justify-between mt-1">
                <span className="text-[10px] text-alma-text-tertiary">
