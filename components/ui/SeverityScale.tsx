        ...
        <button
          ...
          className={`
            ...
            ${value === v
              ...
              : 'border-hlk-border bg-hlk-surface hover:border-hlk-primary/40'
            }
          `}
        >
          <span className={`
            text-xl font-bold
            ${value === v ? 'text-hlk-primary' : 'text-hlk-text-tertiary'}
          `}>
            {v}
          </span>
          <span className={`
            text-[11px] leading-tight text-center
            ${value === v ? 'text-hlk-primary-dark font-semibold' : 'text-hlk-text-tertiary'}
          `}>
            {labels[v - 1]}
          </span>
        </button>
