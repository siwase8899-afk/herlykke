          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur rounded-full border border-white/20 mb-6">
                <span className="w-2 h-2 bg-alma-accent rounded-full animate-pulse" />
                <span className="text-sm font-medium text-white/80">갱년기, 유머로 극복하기</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-4">
                나만 그런 거
                <br />
                <span className="text-alma-accent">아니었어.</span>
              </h1>
              ...
              <div className="mb-8">
                ...
                <p
                  className={`text-base text-white/60 transition-all duration-300 ${
              ...
              <Link
                href="/checkin"
                className="inline-flex items-center justify-center px-8 py-4 bg-alma-accent text-white font-bold rounded-full hover:bg-alma-accent/90 active:scale-[0.98] transition-all shadow-lg shadow-alma-accent/30"
              >
                내 증상 체크하기
            ...
            <div className="relative flex justify-center">
              {/* Main Character Card */}
              <div
                className={`relative bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-8 border border-white/20 max-w-sm w-full transition-all duration-500 ${
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-alma-accent font-medium">
                    {currentChar.name}
                  </p>
                </div>
              ...
              <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-full bg-alma-primary/20 blur-3xl" />
              <div className="absolute -z-10 top-0 right-0 w-32 h-32 rounded-full bg-alma-accent/20 blur-2xl" />
            </div>
          </div>
