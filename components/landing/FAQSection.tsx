...
const faqs = [
  ...
  },
  {
    ...
    a: '체크인 결과를 가족과 공유하면 "엄마가 왜 그러시는지" 이해하는 데 도움이 돼요. HERLYKKE는 갱년기를 겪는 분만을 위한 공간이지만, 가족이 함께 이해하면 더 큰 힘이 됩니다. 곧 "가족을 위한 가이드" 콘텐츠도 준비 중이에요.',
  },
  {
  ...
  {
    q: '어떤 기준으로 그룹이 매칭되나요?',
    a: '증상 유사도, 갱년기 단계, 관심사를 종합적으로 분석해서 가장 공감할 수 있는 그룹으로 연결해요. 언제든 그룹을 바꿀 수 있어요.',
  },
];
